...
Strict correctness and interpretability requirements
...
The project uses the PaySim Financial Transactions Dataset, a synthetic dataset designed to simulate mobile money transactions based on real financial logs.
...
Project Structure
customer-transaction-fraud-pipeline/
├── data/
│   ├── raw/
│   ├── clean/
│   └── processed/
